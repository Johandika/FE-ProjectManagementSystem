...
//     tempNama: Yup.string().required('Nama subkontraktor harus diisi'),
...
//         ),
//     tempIdSubkon: Yup.string().required('ID Subkontraktor harus diisi'),
// })
...
//                             setFieldValue('tempNama', subkon.nama)
...
//                             const subkonId =
//                                 subkontraktorByProyekData[deleteIndex]
...
export default function Subkontraktor() {
    ...
    const allSubkontraktors = useAppSelector(
        (state) => state.proyekDetail.data.subkontraktorsData?.data
    )
    ...
    const loadingAllSubkons = useAppSelector(
        (state) => state.proyekDetail.data.loadingSubkontraktors
    )
