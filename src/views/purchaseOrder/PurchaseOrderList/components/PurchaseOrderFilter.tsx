...
const FilterForm = forwardRef<FormikProps<FormModel>, FilterFormProps>(
    ({ onSubmitComplete }, ref) => {
        ...
        const handleSubmit = (values: FormModel) => {
            ...
            dispatch(getPurchaseOrders(initialTableData))
        }
                ...
                {({ values, touched, errors }) => (
                    <Form>
                        <FormContainer>
                            ...
                            <FormItem
                                invalid={
                                    errors.purchaseOrderStatus &&
                                    touched.purchaseOrderStatus
                                }
                                errorMessage={errors.purchaseOrderStatus}
                            >
                                <h6 className="mb-4">Berkas Pajak Status</h6>
                                <Field name="purchaseOrderStatus">
                                    {({ field, form }: FieldProps) => (
                                        <Radio.Group
                                            vertical
