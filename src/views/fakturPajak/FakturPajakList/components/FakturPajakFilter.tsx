...
const FilterForm = forwardRef<FormikProps<FormModel>, FilterFormProps>(
    ({ onSubmitComplete }, ref) => {
        ...
        const handleSubmit = (values: FormModel) => {
            ...
            dispatch(getFakturPajaks(initialTableData))
        }
                ...
                {({ values, touched, errors }) => (
                    <Form>
                        <FormContainer>
                            ...
                            <FormItem
                                invalid={
                                    errors.fakturPajakStatus &&
                                    touched.fakturPajakStatus
                                }
                                errorMessage={errors.fakturPajakStatus}
                            >
                                <h6 className="mb-4">Berkas Pajak Status</h6>
                                <Field name="fakturPajakStatus">
                                    {({ field, form }: FieldProps) => (
                                        <Radio.Group
                                            vertical
                                            value={values.fakturPajakStatus}
                                            onChange={(val) =>
                                                form.setFieldValue(
                                                    field.name,
                                                    val
...
export default FakturPajakFilter
